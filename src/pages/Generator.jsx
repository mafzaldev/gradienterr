    ...
    <div className="flex flex-col">
      ...
      <div className="flex md:flex-row flex-col justify-center items-center gap-5 md:my-20 my-12">
        <div
          ...
          className={`xl:w-6/12 xl:h-[339px] lg:w-7/12 lg:h-[310px] md:w-8/12 md:h-72 w-11/12 h-64 p-1 rounded
      ...
      {showModal && <Modal gradient={gradient} handleClose={handleModal} />}
    </div>
  );
};
